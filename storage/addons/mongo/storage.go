...
func (f *Storage) loadFile(name string, ctx *loadContext) error {
	candidates := []string{
		filepath.Join(ctx.location, name),
		filepath.Join(ctx.location, name, ".yml"),
		filepath.Join(ctx.location, name, ".yaml"),
	}
...
func (f *Storage) loadYml(data []byte, ctx *loadContext) error {
...
func (f *Storage) loadCollections(ctx *loadContext) error {
	// truncate first
...
func (f *Storage) truncateCollections(collections []loadedCollection) error {
...
func (f *Storage) loadCollection(ctx *loadContext, cl loadedCollection) error {
...
func (f *Storage) buildInsertQuery(ctx *loadContext, cl loadedCollection) ([]map[string]interface{}, error) {
...
func (f *Storage) resolveReference(refs documentsDict, refName string) (document, error) {
...
func (f *Storage) resolveFieldReference(refs documentsDict, ref string) (interface{}, error) {
